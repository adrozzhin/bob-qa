...
- `test-results/<suite>-html-report-<timestamp>/index.html` — full Playwright HTML report (one folder per suite per run)
- `reports/golden-latest.json` — structured golden set results
- `reports/security-latest.json` — structured security test results
- `reports/functional-latest.json` — structured functional test results
...
Bob (Custom GPT at chatgpt.com/g/...)
  ...
  reports/functional-latest.json
        │
        ▼
